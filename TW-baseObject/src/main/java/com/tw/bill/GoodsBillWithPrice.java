...
public class GoodsBillWithPrice {
     ...
     * 会员级别
     */
    private BillConstant.ClubCardType clubCardType = null;
    ...
    public BillConstant.ClubCardType getClubCardType() {
        return clubCardType;
    }

    public void setClubCardType(BillConstant.ClubCardType clubCardType) {
